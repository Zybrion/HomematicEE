...
<head>
    <meta charset="UTF-8">
    <title>HomeMatic | 404 Seite nicht gefunden</title>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="error-page">
                <a href="../index.html"><img src="../dist/img/500_img.png"></a> <br/>
                <h2 class="headline text-yellow"> 404</h2>
                <div class="error-content">
                    <h3><i class="fa fa-warning text-yellow"></i> Oops! Da ist etwas schief gegangen.</h3>
                    <p>
