...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Rezeptverwaltung
                <small>Verwalte deine Rezepte</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="/index.html"><i class="fa fa-dashboard"></i> Haushalt</a></li>
                <li class="active"><a href="../show/manage_recipe.html">Rezept verwalten</a></li>
            </ol>
        </section>
        ...
        <%
            ...
            if (sess != null) {
                ...
                resSetStock = Database.GetDataFromDB("SELECT DISTINCT r.id, r.product_type_id,p.description, d.description, r.amount,  r.description, qu.description, r.daytime_id\n" +
                        "FROM recipe r, product_type p, quantity_unit qu, daytime dt, recipe_description d\n" +
                        "WHERE r.household_id='" + household_id + "' AND r.product_type_id = p.id AND r.recipe_desc_id = d.id AND r.quantity_unit_id = qu.id");
