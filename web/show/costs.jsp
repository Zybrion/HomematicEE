...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Kosten ansehen
                <small>Kosten können hier verwaltet werden</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="../index.html"><i class="fa fa-dashboard"></i>Haushalt</a></li>
                <li><a href="/show/costs.html">Benutzer verwalten</a></li>
            </ol>
        </section>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#manage_costs_id').addClass('active');
    });
</script>
</body>
</html>