<%@ page import="homematic.Database" %>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="/show/manage_stock.jsp"><i class="fa fa-circle-o"></i> Vorrat verwalten</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="/show/create_recipe.jsp"><i class="fa fa-circle-o"></i> Rezept erstellen</a></li>
          </ul>
        </li>
