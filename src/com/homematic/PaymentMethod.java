...
public class PaymentMethod {
    ...
    private String iban;
    private boolean sepa_ddm;

    public PaymentMethod(int id) {
        this.id = id;
    }

    public PaymentMethod(String description, String iban, boolean sepa_ddm) {
    ...
    private int SavePaymentMethodInDB(String description, String iban, boolean sepa_ddm) {
